...
The test was last run on commit `48cab5a3` with gcc version `avr-gcc
...
The test was last run on commit `48cab5a3` with gcc version
...
The test was last run on commit `48cab5a3` with gcc version `pru-gcc
